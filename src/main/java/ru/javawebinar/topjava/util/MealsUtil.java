...
public class MealsUtil {
    public static final List<Meal> meals = Arrays.asList(
            ...
            new Meal(null, LocalDateTime.of(2020, Month.JANUARY, 31, 0, 0), "Еда на граничное " +
                    "значение", 100),
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static List<MealTo> mapToList(List<Meal> meals, int caloriesPerDay) {
        return filteredByStreams(meals, LocalTime.MIDNIGHT, LocalTime.MAX, caloriesPerDay);
    }
