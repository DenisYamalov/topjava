...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 10, 0), "Завтрак ADMIN", 500, 2),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 13, 0), "Обед ADMIN", 1000, 2),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 20, 0), "Ужин ADMIN", 500, 2),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 0, 0), "Еда на граничное значение ADMIN", 100, 2),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 10, 0), "Завтрак ADMIN", 1000, 2),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 13, 0), "Обед ADMIN", 500, 2),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 20, 0), "Ужин ADMIN", 410, 2)
    );
